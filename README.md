...
Generate schema migrations with `npm run db:generate`. Apply the generated SQL to the local DB before testing persistence. Sites packages the Drizzle migrations for deployment.
